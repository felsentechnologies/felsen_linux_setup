...
while true; do
    ...
    echo -en "\e[33mDigite o Dominio para o Duplicati (ex: duplicati.example.com): \e[0m" && read -r url_duplicati
    echo ""
...
## Mensagem de Passo
echo -e "\e[97m- INICIANDO A INSTALACAO DO DUPLICATI \e[33m[1/3]\e[0m"
echo ""
sleep 1
...
cat > duplicati${1:+_$1}.yaml <<__FELSEN_MANAGED_FILE__
version: "3.7"
services:
...
## --------------------------- FELSEN --------------------------- ##
  ...
  duplicati${1:+_$1}:
    ...
    environment:
    ## Configuracao basica do webservice
...
if [ $? -eq 0 ]; then
    ...
    echo "Nao foi possivel criar a stack do duplicati"
fi
...
#    echo "Nao foi possivel Subir a stack do duplicati"
#fi
...
cat > dados_duplicati${1:+_$1} <<__FELSEN_MANAGED_FILE__
[ DUPLICATI ]
