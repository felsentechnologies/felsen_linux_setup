...
## Mensagem de Passo
echo -e "\e[97m- INICIANDO A INSTALACAO DA EVOLUTION API \e[33m[1/4]\e[0m"
echo ""
sleep 1
...
cat > evolution${1:+_$1}.yaml <<__FELSEN_MANAGED_FILE__
version: "3.7"
services:
...
## --------------------------- FELSEN --------------------------- ##
  ...
  evolution${1:+_$1}_api:
    image: evoapicloud/evolution-api:latest ## Versao da Evolution API
    ...
    ## Pegue a versao em: https://web.whatsapp.com/sw.js
      ...
      - CONFIG_SESSION_PHONE_CLIENT=Felsen Linux Setup
...
cat > dados_evolution${1:+_$1} <<__FELSEN_MANAGED_FILE__
[ EVOLUTION API ]
